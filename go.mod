module github.com/132982317/profstik
...
require (
	...
	github.com/cloudwego/kitex-examples/bizdemo/easy_note v0.0.0-20230314091025-1a0bcba6b443
...
require (
	github.com/a76yyyy/ErrnoCode v1.0.2 // indirect
